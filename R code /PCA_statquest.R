...
library(ggplot2)
# Create data set for PCS 
data.matrix <- matrix(nrow=100, ncol=10)
colnames(data.matrix) <- c(
  paste("wt", 1:5, sep=""),   # wt normal 
  paste("ko", 1:5, sep="")).  # knockout samples 
...
# prcomp wants gene as columns, and sampels to be rows therefor transpose 
